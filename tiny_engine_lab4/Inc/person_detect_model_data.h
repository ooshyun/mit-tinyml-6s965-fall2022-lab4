...
extern const unsigned char quantized_half_model_tflite[];
extern const int quantized_half_model_tflite_len;

extern const unsigned char out_tflite[];
extern const int out_tflite_len;
